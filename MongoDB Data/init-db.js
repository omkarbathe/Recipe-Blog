...
db = db.getSiblingDB('recipeblog');

// --- Recipes Collection ---
const recipesData = [{
    "_id": ObjectId("614dd8d3c59f69c8ebcc18a1"),
    "name": "Crab cakes",
    ...
    "_id": ObjectId("614dd8d3c59f69c8ebcc18a7"),
    ...
    "_id": ObjectId("614dd8d3c59f69c8ebcc18a8"),
    "name": "Thai-style mussels",
    ...
    "_id": ObjectId("614dd8d3c59f69c8ebcc18aa"),
    ...
    "email": "hello@email.com",
    "ingredients": ["5 cm piece of ginger", "1 fresh red chilli", "25 g sesame seeds", "24 raw peeled king prawns , from sustainable sources (defrost first, if using frozen)", "1 pinch Chinese five-spice powder"],
    "category": "Chinese",
    "image": "thai-chinese-inspired-pinch-salad.jpg",
    "__v": 0
}, {
    "_id": ObjectId("614dd8d3c59f69c8ebcc189e"),
    ...
    "email": "hello@email.com",
    "ingredients": ["4 free-range chicken thighs , skin on, bone in", "4 free-range chicken drumsticks", "200 ml buttermilk", "4 sweet potatoes", "200 g plain flour", "1 level teaspoon baking powder", "1 level teaspoon cayenne pepper", "1 level teaspoon hot smoked paprika"],
    "category": "American",
    "image": "southern-friend-chicken.jpg",
    "__v": 0
}, {
    "_id": ObjectId("614dd8d3c59f69c8ebcc18a0"),
    ...
    "email": "hello@email.com",
    "ingredients": ["3 spring onions", "½ a bunch of fresh flat-leaf parsley", "1 large free-range egg", "750 g cooked crabmeat , from sustainable sources", "300 g mashed potatoes", "1 teaspoon ground white pepper", "1 teaspoon cayenne pepper", "olive oil"],
    "category": "American",
    "image": "chocolate-banoffe-whoopie-pies.jpg",
    "__v": 0
}, {
    "_id": ObjectId("614dd8d3c59f69c8ebcc18a4"),
    ...
    "_id": ObjectId("614dd8d3c59f69c8ebcc18a9"),
    ...
    "_id": ObjectId("614dd8d3c59f69c8ebcc18ab"),
    "name": "Spring rolls",
    ...
    "_id": ObjectId("614dd8d3c59f69c8ebcc18ad"),
    ...
    "email": "hello@email.com",
    "ingredients": ["1 x 227 g tin of pineapple in natural juice", "1 x 213 g tin of peaches in natural juice", "1 tablespoon low-salt soy sauce", "1 tablespoon fish sauce", "2 teaspoons cornflour", "2 x 120 g free-range chicken breasts , skin on"],
    "category": "Chinese",
    "image": "tom-daley.jpg",
    "__v": 0
}, {
    "_id": ObjectId("614dd8d3c59f69c8ebcc189f"),
    "name": "Crab cakes",
    ...
    "_id": ObjectId("614dd8d3c59f69c8ebcc18a5"),
    ...
    "_id": ObjectId("614dd8d3c59f69c8ebcc18a2"),
    "name": "Key lime pie",
    "description": "\n        Preheat the oven to 175ºC/gas 3. Lightly grease a 22cm metal or glass pie dish with a little of the butter.\n        For the pie crust, blend the biscuits, sugar and remaining butter in a food processor until the mixture resembles breadcrumbs.\n        Transfer to the pie dish and spread over the bottom and up the sides, firmly pressing down.\n        Bake for 10 minutes, or until lightly browned. Remove from oven and place the dish on a wire rack to cool.\n        For the filling, whisk the egg yolks in a bowl. Gradually whisk in the condensed milk until smooth.\n        Mix in 6 tablespoons of lime juice, then pour the filling into the pie crust and level over with the back of a spoon.\n        Return to the oven for 15 minutes, then place on a wire rack to cool.\n        Once cooled, refrigerate for 6 hours or overnight.\n        To serve, whip the cream until it just holds stiff peaks. Add dollops of cream to the top of the pie, and grate over some lime zest, for extra zing if you like.\n    \n        Source: https://www.jamieoliver.com/recipes/fruit-recipes/key-lime-pie/",
    "email": "hello@email.com",
    "ingredients": ["4 large free-range egg yolks", "400 ml condensed milk", "5 limes", "200 ml double cream"],
    ...
    "_id": ObjectId("614dd8d3c59f69c8ebcc18a3"),
    ...
    "email": "hello@email.com",
    "ingredients": ["85 g butter", "6 submarine rolls", "500 g cooked lobster meat, from sustainable sources", "1 stick of celery", "2 tablespoons mayonnaise , made using free-range eggs"],
    "category": "American",
    "image": "grilled-lobster-rolls.jpg",
    "__v": 0
}, {
    "_id": ObjectId("614dd8d3c59f69c8ebcc18a6"),
    ...
    "email": "hello@email.com",
    "ingredients": ["1 butternut squash (1.2kg)", "groundnut oil", "12x 400 g tins of light coconut milk", "400 g leftover cooked greens, such as", "Brussels sprouts, Brussels tops, kale, cabbage, broccoli"],
    "category": "Thai",
    "image": "thai-green-curry.jpg",
    "__v": 0
}, {
    "_id": ObjectId("614dd8d3c59f69c8ebcc18ac"),
    ...
    "email": "hello@email.com",
    "ingredients": ["1 clove of garlic", "1 fresh red chilli", "3 spring onions", "1 small red onion", "1 handful of mangetout", "a few shiitake mushrooms"],
    "category": "Chinese",
    "image": "stir-fried-vegetables.jpg",
    "__v": 0
}, {
    "_id": ObjectId("614df88c3a1dc54758844690"),
...
const categoriesData = [{
    "_id": ObjectId("614dd75a9693912a00f0514d"),
    "name": "American",
    "image": "american-food.jpg",
    "__v": 0
}, {
    "_id": ObjectId("614dd75a9693912a00f0514e"),
    "name": "Chinese",
    "image": "chinese-food.jpg",
    "__v": 0
}, {
    "_id": ObjectId("614dd75a9693912a00f0514c"),
    "name": "Thai",
    "image": "thai-food.jpg",
    "__v": 0
}, {
    "_id": ObjectId("614dd75a9693912a00f0514f"),
    "name": "Mexican",
    "image": "mexican-food.jpg",
    "__v": 0
}, {
    "_id": ObjectId("614dd75a9693912a00f05150"),
    "name": "Indian",
    "image": "indian-food.jpg",
    "__v": 0
}, {
    "_id": ObjectId("614dd75a9693912a00f05151"),
    "name": "Spanish",
...
// --- Execution ---
db.recipes.insertMany(recipesData);
db.categories.insertMany(categoriesData);

print('SUCCESS: Database recipeblog initialized with all records!');